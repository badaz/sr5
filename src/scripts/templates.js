...
export const preloadHandlebarsTemplates = async function () {
  ...
  const templatePaths = [
    ...
    "systems/sr5/assets/img/icons/nav-attributes.svg.hbs",
    "systems/sr5/assets/img/icons/nav-augmentations.svg.hbs",
    "systems/sr5/assets/img/icons/nav-bio.svg.hbs",
    "systems/sr5/assets/img/icons/nav-configuration.svg.hbs",
    "systems/sr5/assets/img/icons/nav-contacts.svg.hbs",
    "systems/sr5/assets/img/icons/nav-deck.svg.hbs",
    "systems/sr5/assets/img/icons/nav-derived.svg.hbs",
    "systems/sr5/assets/img/icons/nav-gear.svg.hbs",
    "systems/sr5/assets/img/icons/nav-information.svg.hbs",
    "systems/sr5/assets/img/icons/nav-magic.svg.hbs",
    "systems/sr5/assets/img/icons/nav-matrix.svg.hbs",
    "systems/sr5/assets/img/icons/nav-modifiers.svg.hbs",
    "systems/sr5/assets/img/icons/nav-qualities.svg.hbs",
    "systems/sr5/assets/img/icons/nav-skills.svg.hbs",
    "systems/sr5/assets/img/icons/nav-spells.svg.hbs",
    "systems/sr5/assets/img/icons/nav-weapons.svg.hbs",
    "systems/sr5/assets/img/icons/nav-materialize.svg.hbs",
    "systems/sr5/assets/img/icons/nav-dismiss.svg.hbs",
    "systems/sr5/assets/img/icons/nav-link.svg.hbs",
